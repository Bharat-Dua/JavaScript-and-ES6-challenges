...
function carInfo(car) {
  if (car.price <= 20000)
    console.log(
      `The ${car.brand} is a cheap car, priced at only $${car.price}.`
    );
  else
    console.log(
      `The ${car.brand} is an expensive car, priced at $${car.price}. It is not recommended for the budget conscious buyer.`
    );
}
